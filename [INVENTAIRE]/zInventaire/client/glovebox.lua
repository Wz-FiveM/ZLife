...
RegisterNetEvent("c_inventaire:openGloveboxInventory")
AddEventHandler(
    "c_inventaire:openGloveboxInventory",
...
RegisterNetEvent("c_inventaire:refreshGloveboxInventory")
AddEventHandler(
    "c_inventaire:refreshGloveboxInventory",
    function(data, blackMoney, inventory, weapons)
        setGloveboxInventoryData(data, blackMoney, inventory, weapons)
    end
)
