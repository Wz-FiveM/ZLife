...
Config.noclip_speed = 2.5 -- change it to change the speed in noclip
...
Config.Menus = {
	...
	modFrontWheelsTypes = {
		...
		modFrontWheelsType8	= "Bespokes Smokes",
		modFrontWheelsType9	= "Bespokes Originals",
		modFrontWheelsType10	= "Street"
	},
	modFrontWheelsType0 = {
		label = _U('sport'),
