...
function UIMenu.New(Title, Subtitle, X, Y, TxtDictionary, TxtName, Heading, R, G, B, A)
    ...
    --_UIMenu.ArrowSprite = Sprite.New("commonmenu", "shop_arrows_upanddown", 190 + _UIMenu.Position.X, 147 + 33 * (_UIMenu.Pagination.Total + 1) + _UIMenu.Position.Y - 33 + _UIMenu.Subtitle.ExtraY, 50, 50)
    --_UIMenu.Extra.Up = UIResRectangle.New(0 + _UIMenu.Position.X, 144 + 38 * (_UIMenu.Pagination.Total + 1) + _UIMenu.Position.Y - 33 + _UIMenu.Subtitle.ExtraY, 431, 18, 0, 0, 0, 200)
    --_UIMenu.Extra.Down = UIResRectangle.New(0 + _UIMenu.Position.X, 144 + 18 + 38 * (_UIMenu.Pagination.Total + 1) + _UIMenu.Position.Y - 33 + _UIMenu.Subtitle.ExtraY, 431, 18, 0, 0, 0, 200)
    ...
    _UIMenu.Background = Sprite.New("commonmenu", "gradient_bgd", _UIMenu.Position.X, 140.5 + _UIMenu.Position.Y - 0 + _UIMenu.Subtitle.ExtraY, 290, 25)
...
function UIMenu:RecalculateDescriptionPosition()
    ...
    self.Description.Bar:Position(self.Position.X, 139 + self.Position.Y + WindowHeight)
    self.Description.Rectangle:Position(self.Position.X, 139.3 + self.Position.Y + WindowHeight)
    self.Description.Text:Position(self.Position.X + 8, 143 + self.Position.Y + WindowHeight)
...
function UIMenu:DrawCalculations()
    ...
    self.Background:Size(431 + self.WidthOffset, self:CalculateItemHeight() + WindowHeight + ((self.Subtitle.ExtraY > 0) and 0 or 33))
...
function UIMenu:Draw()
    ...
    if #self.Windows ~= 0 then
        ...
        for index = 1, #self.Windows do
            ...
            Window:Position(WindowOffset + self.Subtitle.ExtraY - 33)
            Window:Draw()
        end
    end
    if #self.Items == 0 then
    ...
    if #self.Items <= self.Pagination.Total + 1 then
        local ItemOffset = self.Subtitle.ExtraY - 33 + WindowHeight
