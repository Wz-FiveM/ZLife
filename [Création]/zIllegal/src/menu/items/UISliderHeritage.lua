...
local SettingsButton = {
    Rectangle = { Y = 0, Width = 332, Height = 33 },
    Text = { X = 8, Y = 3, Scale = 0.28 },
    SelectedSprite = { Dictionary = "commonmenu", Texture = "gradient_nav", Y = 0, Width = 332, Height = 33 },
}

---@type table
local SettingsSlider = {
    Background = { X = 170, Y = 14.5, Width = 150, Height = 9 },
    Slider = { X = 170, Y = 14.5, Width = 75, Height = 9 },
    Divider = { X = 245, Y = 10.5, Width = 2.5, Height = 15 },
    LeftArrow = { Dictionary = "mpleaderboard", Texture = "leaderboard_female_icon", X = 155, Y = 9.5, Width = 18, Height = 18 },
    RightArrow = { Dictionary = "mpleaderboard", Texture = "leaderboard_male_icon", X = 316, Y = 9.5, Width = 18, Height = 18 },
}
