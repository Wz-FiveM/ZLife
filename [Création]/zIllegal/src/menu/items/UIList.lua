...
local SettingsButton = {
    ...
    RightBadge = { X = 325, Y = -2, Width = 40, Height = 40 },
    RightText = { X = 325, Y = 4, Scale = 0.35 },
    SelectedSprite = { Dictionary = "commonmenu", Texture = "gradient_nav", Y = 0, Width = 332, Height = 33 },
}

---@type table
local SettingsList = {
    LeftArrow = { Dictionary = "commonmenu", Texture = "arrowleft", X = 300, Y = 8, Width = 18, Height = 18 },
    RightArrow = { Dictionary = "commonmenu", Texture = "arrowright", X = 310, Y = 8, Width = 18, Height = 18 },
    Text = { X = 305, Y = 3, Scale = 0.30 },
}
