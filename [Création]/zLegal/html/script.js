    ...
    window.addEventListener('message', function(event) {
        ...
        if (event.data.type == 'GUI_pmobilet') {
            ...
            if (event.data.StatusJS == true) {
                ...
                $.post('http://zLegal/esx_policemdt:GetWarrantsClient', JSON.stringify({
            ...
            if (event.data.ForceVehSearch == true) {
                ...
                $.post('http://zLegal/esx_policemdt:SearchVehicleClient', JSON.stringify({
            ...
            if (event.data.report_added == true) {
                ...
                document.getElementById("notify_text").innerHTML = 'Un nouveau rapport a été envoyé';
