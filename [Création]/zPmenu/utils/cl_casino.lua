...
-- }
-- local z = "vw_prop_casino_roulette_01"
-- local Qlmlet = false;
-- local xSebv5Jc = vec3(1116.02, 234.04, -50.84)
-- local VcV0EuD = {-135.0, 45.0, 135.0, -45.0, -45.0, 135.0}
-- local XWsds454 = {
--     vec3(935.8, 47.24, 81.08),
--     vec3(1089.72, 206.2, -49.0),
-- }
-- local pX4gCR = {
--     vec3(1144.814, 268.2634, -52.8409), 
--     vec3(1150.355, 262.7224, -52.8409),
--     vec3(1133.958, 262.1071, -52.0409), 
--     vec3(1129.595, 267.2637, -52.0409),
--     vec3(1144.618, 252.2411, -52.0409), 
--     vec3(1148.981, 247.0846, -52.0409)
-- }
-- local E = vec3(1110.15, 229.23, -49.64)
-- local OO = "ANIM_CASINO_A@AMB@CASINO@GAMES@LUCKY7WHEEL@MALE"
-- local y = "vw_prop_vw_luckywheel_02a"
-- local cR6rJlAl

-- local function fs52REi()
--     RequestAndWaitModel(z)
-- end
-- local function MV65()
--     RequestAndWaitModel(y)
--     RequestAnimDict(OO)
--     cR6rJlAl = CreateObjectNoOffset(GetHashKey(y), 1111.052, 229.8579, -49.133, 0, 0, 1)
--     SetModelAsNoLongerNeeded(y)
--     SetEntityCanBeDamaged(cR6rJlAl, false)
--     SetEntitySomething(cR6rJlAl, true)
-- end
-- local function h(sUQpby)
--     for mbA, _qPhpaFx in pairs(CM) do
--         if sUQpby then
--             RequestIpl(_qPhpaFx)
--         end
--     end
...
--     MV65()
-- end
-- local function EnterCasino(bool)
--     if bool then 
--         j2K()
--         SetEntityCoordsNoOffset(GetPlayerPed(-1), 1089.72, 206.2, -49.0, false, false, false, false)
--     else
--         Qlmlet = false
--         h(false)
--         SetEntityCoordsNoOffset(GetPlayerPed(-1), 935.8, 47.24, 81.08, false, false, false, false)
--     end
-- end
...
--                     attente = 1
--                     DrawTopNotification("Appuyez sur ~INPUT_PICKUP~ pour jouer au ~y~blackjack~s~.")
--                 end
--             end      
--         end     
--         Wait(attente)
...
--                 AddTextComponentString("Votre main [~b~"..tostring(currentHand).."~s~] - Main du croupier [~b~"..tostring(dealersHand).."~s~]")
...
--                     local tmpInput = getGenericTextInput("Montant du pari")
...
--                         Wait(1000)
--                     else
--                         ShowAboveRadarMessage("~r~Montant non valable.")
--                     end
--                 end      
--             end
--         end
...
--                     DrawAdvancedNativeText(0.995, 0.935, 0.005, 0.0028, 0.29, "Montant:", 255, 255, 255, 255, 0, 0)
...
--                 attente = 1
--                 DrawRect(0.940, 0.886, 0.081, 0.032, 0, 0, 0, 150)
...
--                     DrawAdvancedNativeText(1.05, 0.885, 0.005, 0.0022, 0.464, "00:0" .. tostring(timeLeft), 255, 255, 255, 255, 0, 0)
--                 else
...
--     ClearHelp(true)
--     DrawTopNotification("Veuillez faire vos jeux.")
...
--             ShowAboveRadarMessage("~r~Vous n'avez pas placé de pari, round sauté")
--         end
--     end)
-- end)
...
--                     TriggerServerEvent("Blackjack:standBlackjack",globalGameId,globalNextCardCount)
--                     declineCard()
--                     DrawTopNotification("Failed to stand/hit in time, standing.")
--                 end
--             end)
--         else 
...
--     DrawTopNotification("En attendant le début du prochain jeu...")
--     blackjackAnimsToLoad = {
--       "anim_casino_b@amb@casino@games@blackjack@dealer",
--       "anim_casino_b@amb@casino@games@shared@dealer@",
--       "anim_casino_b@amb@casino@games@blackjack@player",  
...
--         angryILost()
--         canExitBlackjack = true
--         DrawTopNotification("~r~Vous avez perdu !")
--         drawCurrentHand = false
--         currentHand = 0
--         dealersHand = 0
--     end
...
--         annoyedIPushed()
--         canExitBlackjack = true
--         DrawTopNotification("~b~Vous avez fait égalité !")
--         drawCurrentHand = false
--         currentHand = 0
--         dealersHand = 0
--     end
...
--         happyIWon()
--         canExitBlackjack = true
--         DrawTopNotification("~g~Vous avez gagnez !")
--         drawCurrentHand = false
--         currentHand = 0
--         dealersHand = 0
--     end
...
--     ButtonMessage("Placez un pari") --ENTER
--     PopScaleformMovieFunctionVoid()

--     PushScaleformMovieFunction(scaleform, "SET_DATA_SLOT")
--     PushScaleformMovieFunctionParameterInt(4)
--     Button(GetControlInstructionalButton(2, 22, true))
--     ButtonMessage("Mise personnalisé") --Space
--     PopScaleformMovieFunctionVoid()  
...
--     PushScaleformMovieFunctionParameterInt(1)
--     Button(GetControlInstructionalButton(2, 194, true)) -- The button to display
--     ButtonMessage("Pas de carte") --BACKSPACE
--     PopScaleformMovieFunctionVoid()

--     PushScaleformMovieFunction(scaleform, "SET_DATA_SLOT")
--     PushScaleformMovieFunctionParameterInt(4)
--     Button(GetControlInstructionalButton(2, 22, true))
--     ButtonMessage("Une carte") --Space
--     PopScaleformMovieFunctionVoid()  
...
--     while true do 
--         local attente = 500
--         local Xcc4 = LocalPlayer()
--         local fqw5, qnVfOeRE = Xcc4.Pos, Xcc4.interiorID
--         for k, v in pairs(XWsds454) do
--             if Vdist2(fqw5, v) < 2.5 then
--                 attente = 1
--                 DrawTopNotification('Appuyez sur ~INPUT_CONTEXT~ pour accéder au ~q~Casino~s~.')
--                 if IsControlJustPressed(0, 51) then 
--                     if Qlmlet then 
--                         EnterCasino(false)
--                     elseif not Qlmlet then 
--                         EnterCasino(true)
--                     end
--                 end
--             end
