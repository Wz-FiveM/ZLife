        ...
        if not blackjackGameInProgress[gameId] then
            if tonumber(betAmount) then
                ...
                if betAmount > 15000 then
                    TriggerClientEvent("blackjack:notify",source,"~r~Les paris au dessus de 15k ne sont pas accepté.")
                else 
                    if tryTakeChips(source,betAmount) then
                        ...
                        TriggerClientEvent("blackjack:notify",source,"Vous avez parié ~b~" .. tostring(betAmount) .. "$ ~s~.")
                    end
                end
            end
        end
                                        ...
                                        while nextCardCount >= 1 do
                                            ...
                                            if blackjackGameData[gameId][source][2][nextCardCount] == true then --if hit 
                                                ...
                                                if currentHand > 21 then
                                                    ...
                                                    TriggerClientEvent("blackjack:notify",source,"Vous avez perdu ~r~"..tostring(lostAmount).."$~s~.")
                                                ...
                                                if dealerHand > 21 then
                                                    ...
                                                    if playerPing ~= nil then
                                                        if playerPing > 0 then
                                                            ...
                                                            TriggerClientEvent("blackjack:notify",source,"Vous avez gagné ~g~"..tostring(potentialWinAmount).."$~s~.")
                                                ...
                                                elseif currentHand == dealerHand then
                                                    ...
                                                    if playerPing ~= nil then
                                                        if playerPing > 0 then
                                                            ...
                                                            TriggerClientEvent("blackjack:notify",source,"Vous avez gagné ~g~0$~s~.")
                                                        end
                                                    end
                                                else
                                                    ...
                                                    if playerPing ~= nil then
                                                        if playerPing > 0 then
                                                            ...
                                                            TriggerClientEvent("blackjack:notify",source,"Vous avez perdu ~r~"..tostring(potentialPushAmount).."$~s~.")
                                                            --[[ if potentialPushAmount > 10000000 then
