...
MySQL.Async.execute(
		...
		function(result)
				TriggerClientEvent('esx:showNotification', xPlayer.source, '~g~Vous avez un nouvelle paire de clés.')
				TriggerClientEvent('esx:showNotification', _source, '~g~Clés bien enregistrer.')
		end)
end)
-----------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------
