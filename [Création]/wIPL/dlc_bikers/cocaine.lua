...
BikerCocaine = {
    ...
    Style = {
        ...
        Clear = function(refresh)
            SetIplPropState(BikerCocaine.interiorId, {BikerCocaine.Style.basic, BikerCocaine.Style.upgrade}, true, refresh)
        end
    },
    Security = {
        ...
        Clear = function(refresh)
            SetIplPropState(BikerCocaine.interiorId, {BikerCocaine.Security.basic, BikerCocaine.Security.upgrade}, true, refresh)
        end
    },
    Details = {
