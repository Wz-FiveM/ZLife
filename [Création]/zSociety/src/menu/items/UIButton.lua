...
local SettingsButton = {
    Rectangle = { Y = 0, Width = 332, Height = 31 },
    Text = { X = 8, Y = 3, Scale = 0.28 },
    LeftBadge = { Y = -2, Width = 40, Height = 40 },
    RightBadge = { X = 332, Y = -2, Width = 40, Height = 40 },
    RightText = { X = 325, Y = 4, Scale = 0.26 },
    SelectedSprite = { Dictionary = "commonmenu", Texture = "gradient_nav", Y = 0, Width = 332, Height = 31 },
}
...
function RageUI.Separator(Label)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() then
            ...
            if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
                if (Label ~= nil) then
                    RenderText(Label, CurrentMenu.X + SettingsButton.Text.X + 200.0, CurrentMenu.Y + SettingsButton.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 0, 0.25, 245, 245, 245, 255,1)
                end
                RageUI.ItemOffset = RageUI.ItemOffset + SettingsButton.Rectangle.Height
