...
RageUI.Settings = {
    ...
    Items = {
        Title = {
            Background = { Width = 332, Height = 72 },
            Text = { X = 162, Y = 12, Scale = 0.80 },
        },
        Subtitle = {
            Background = { Width = 332, Height = 33 },
            Text = { X = 8, Y = 4, Scale = 0.28 },
            PreText = { X = 332, Y = 5, Scale = 0.28 },
        },
        
        Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 0, Width = 332 },
        Navigation = {
            Rectangle = { Width = 332, Height = 18 },
            Offset = 5,
            Arrows = { Dictionary = "commonmenu", Texture = "shop_arrows_upanddown", X = 190, Y = -6, Width = 50, Height = 50 },
        },
        Description = {
            Bar = { Y = 4, Width = 332, Height = 4 },
            Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 4, Width = 332, Height = 26 },
            Text = { X = 8, Y = 8, Scale = 0.28 },
        },
    },
    Panels = {
        Grid = {
            Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 4, Width = 332, Height = 275 },
        ...
        Percentage = {
            Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 4, Width = 332, Height = 76 },
