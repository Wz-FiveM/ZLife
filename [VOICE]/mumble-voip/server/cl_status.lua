...
RegisterNetEvent('esx_health:pl')
AddEventHandler('esx_health:pl', function(xPlayer)
    PlayerLoaded = true
end)
...
RegisterNetEvent('c_health:upstarhe')
AddEventHandler('c_health:upstarhe', function(health)
