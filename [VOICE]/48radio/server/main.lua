...
RegisterServerEvent('alertegabng')
AddEventHandler('alertegabng', function(gang, closest)
	local _source = source
	...
	for i = 1, #xPlayers, 1 do
		...
		if thePlayer.org.name == gang then
			TriggerClientEvent('alertegang', xPlayers[i], closest)
		end
	end
end)

RegisterServerEvent('alertegabngat')
AddEventHandler('alertegabngat', function(pgang, closest)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local xPlayers = ESX.GetPlayers()
	print(pgang)
	...
	for i = 1, #xPlayers, 1 do
		local thePlayer = ESX.GetPlayerFromId(xPlayers[i])
		if thePlayer.org.name == pgang then
			TriggerClientEvent('alertegangat', xPlayers[i], closest)
		end
	end
end)